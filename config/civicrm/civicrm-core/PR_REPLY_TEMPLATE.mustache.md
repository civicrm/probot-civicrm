...
- `/rebase <?branch-name>` will rebase your branch and change the base of the PR (if `<branch-name>` is specified).
...
- `/lint` will automatically fix linting errors, amending commits as needed.
